...
const Heropage = () => {
  return (
    <div className='w-full lg:bg-[url("/homepage.jpg")] bg-[url("/heropage2.jpg")] lg:bg-auto bg-cover sm:bg-center lg:h-screen h-[80vh] lg:pt-20 lg:pl-20 p-5 leading-[50px]'>
